# マ:毛マ＞主:派服＞ガ:身服
def hero_GaboStone4(seed_type: :rand)
  Game_Actor.new(
    name: "主",
...
def mari_GaboStone4(seed_type: :rand, mari_lv11: false)
  Game_Actor.new(
    name: "マ",
...
def gabo_GaboStone4(seed_type: :rand)
  Game_Actor.new(
    name: "ガ",
...
Party_GaboStone4 = ->seed_type: :rand, mari_lv11: false{
  hero = hero_GaboStone4(seed_type: seed_type)
  mari = mari_GaboStone4(seed_type: seed_type, mari_lv11: mari_lv11)
  gabo = gabo_GaboStone4(seed_type: seed_type)

  Game_Party_Pingval.new(mari, hero, gabo, npc_Kasim)
}

Party_GaboStone4_GA = ->seed_type: :rand, mari_lv11: false{
  hero = hero_GaboStone4(seed_type: seed_type)
  mari = mari_GaboStone4(seed_type: seed_type, mari_lv11: mari_lv11)
  gabo = gabo_GaboStone4(seed_type: seed_type)
